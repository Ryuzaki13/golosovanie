...
CREATE TABLE "votes" (
    ...
    "votes" integer ARRAY NOT NULL, --голоса за песню
...
INSERT INTO "songs" VALUES (0,'','',TRUE);
...
INSERT INTO "votes" ("voting_id", "song_id", "votes") VALUES
    ('1', '1', '{1870,1136,1094,1333,1358,1310,1023,1119,1668}'),
    ('1', '2', '{1170,1186,1504,1945,1694}'),
    ('1', '3', '{12345,1040,1421,1008,1623,1269,1629}'),
    ('1', '4', '{1920,1485,1705,1264,1787,1438,1246,1270,1784,1874}'),
    ('1', '5', '{1323,1402,1288,1996,1752,1670,1971}'),
    ('2', '1', '{1831,1298,1692,1335,1788,1153,1488,1519,1770,1595}'),
    ('2', '7', '{1969,1765,1421,1648,1997,1400,1103,1854,1182}'),
    ('2', '8', '{1317,1341,1421,1665,1179,1730,1930,1117}'),
    ('2', '9', '{1311,1607,1942,1232}'),
    ('2', '10','{1778}'),
    ('3', '1', '{1189,1534,1949,1770,1718,1749}'),
    ('3', '5', '{1656,1849,1834,1449,1141,1235,1147,1569,1705,1529}'),
    ('3', '3', '{12345,1893,1501,1889,1694,1521,1317,1019,1302,1158}'),
    ('3', '2', '{1632,1325,1510,1286,1220,1503,1332,1071,1029}'),
    ('3', '4', '{1753,1793,1414}');
